...
const ImagePage=()=>{
    ...
    return(
        ...
        <div>
            <Heading
            title="Gerar imagens"
            description="Coloque um prompt para gerar uma imagem."
            icon={ImageIcon}
                    ...
                    <Form {...form}>
                        ...
                        <FormField name="prompt" render={({field})=>(<FormItem className="col-span-12 lg:col-span-6">
                            <FormControl className="m-0 p-0">
                                ...
                                focus-visible:ring-transparent" disabled={isLoading} placeholder="Criar uma imagem de um celular realista."{...field}/>
                            </FormControl>
                        </FormItem>)}/>
                        <FormField 
