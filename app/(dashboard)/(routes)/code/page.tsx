...
const CodePage=()=>{
    ...
    return(
        ...
        <div>
            <Heading
            title="Gerar Código"
            description="Um sistema de IA que converte descrições em códigos automaticamente."
            icon={Code}
                    ...
                    <Form {...form}>
                        ...
                        <FormField name="prompt" render={({field})=>(<FormItem className="col-span-12 lg:col-span-10">
                            <FormControl className="m-0 p-0">
                                ...
                                focus-visible:ring-transparent" disabled={isLoading} placeholder="Digite qual código deseja criar..."{...field}/>
                            </FormControl>
                        </FormItem>)}/>
